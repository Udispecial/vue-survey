  ...
  <div>
    ...
    <div class="flex items-center justify-between">
      ...
      <div class="flex items-center">
        ...
        <button
          ...
          class="flex items-center text-xs py-1 px-3 border border-transparent rounded-sm text-white bg-red-500 hover:bg-red-600"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            class="h-4 w-4"
    ...
    <div class="grid gap-3 grid-cols-12">
      ...
      <div class="mt-3 col-span-3">
        ...
        <select
          ...
          v-model="model.type"
          @change="typeChange"
          class="mt-1 w-full block py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
        >
    ...
    <div>
      <div v-if="shouldHaveOptions()" class="mt-2">
        <h4
          class="text-sm font-semibold mb-1 flex items-center justify-between"
        >
          Options
        ...
        >
          ...
          <button
            ...
            class="flex items-center text-xs py-1 px-3 border border-transparent rounded-sm text-white transition-colors hover:bg-red-100"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
